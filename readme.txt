...
Contributors: colomet, dcazzorla, lukastonhajzer
...
1. Upload the plugin files to the `/wp-content/plugins/simple-metadata-relation` directory, or install the plugin
